...
def post_train(encoded_images, url="http://0.0.0.0:7860",user_id="test"):
    datas = json.dumps(
        {
            ...
            "sd_model_checkpoint": "majicmixRealistic_v7.safetensors",  #"Chilloutmix-Ni-pruned-fp16-fix.safetensors",
            "train_mode_choose": "Train Human Lora",
            "resolution": 512,
            "val_and_checkpointing_steps": 100,
            "max_train_steps": 800,  # Training steps  # 800
    ...
    r = requests.post(f"{url}/easyphoto/easyphoto_train_forward", data=datas)
